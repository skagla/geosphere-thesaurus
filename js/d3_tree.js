...
treeChart = function (data) {
  ...
  const svg = d3
    ...
    .attr(
      "style",
      "max-width: 100%; height: auto; font-size: 14px; user-select: none;",
    );
  ...
  function update(event, source) {
    ...
    nodeEnter
      ...
      .attr("fill", (d) =>
        d.data.c && d.data.c.length > 0 ? "#2020ff" : "grey",
      )
      .attr("style", (d) =>
        d.data.c && d.data.c.length > 0 ? "text-decoration: underline;" : "",
      )
